---
title: KeePass
date: 2023-06-20 23:05:29
permalink: /pages/7d1889/
categories:
  - 运维
  - 运维工具
  - 远程工具
...
::: center
  ### KeePass + PuTTY + RDP 密码管理+远程Linux与Windows远程
  （可用于标题、图片等的居中）
:::
...
[访问keepass官网](https://keepass.info/download.html)

[可下载最新的releases版本](https://sourceforge.net/projects/keepass/files/KeePass%202.x/2.54/KeePass-2.54.zip/download)

[PuTTY 汉化版本](https://github.com/larryli/PuTTY)
